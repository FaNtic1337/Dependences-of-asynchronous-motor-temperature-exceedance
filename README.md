# Dependences-of-asynchronous-motor-temperature-exceedance
...
- [Теория](#Теория)
  - [Описание основных режимов](#Описание-основных-режимов)
    ...
    - [S3 — повторно-кратковременный периодический режим](#S3--повторнократковременный-периодический-режим)
